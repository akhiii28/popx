    ...
    return (
        <div className="welcome-container" id="login">
            ...
            <div className="form-group"  style={{marginBottom:"2px", marginTop:"-5px"}}>
                ...
                <input className="logbox" type="email" id="Email" name="Email" placeholder="Enter email address" required /><br />
            </div>
            <div className="form-group" style={{marginBottom:"10px"}}>
                <label for="Password" className="boxLabel">Password</label><br />
                <input className="logbox" type="password" id="Password" name="Password" placeholder="Enter password" required /><br />
            </div>
            <div className="login-btn">
            <button className="btn btn-third" type="submit" >Login</button>
        </div>
        </form>
        </div>
